...
class Pattern(SQLModel, table=True):
    ...
    # JSONB fields for logic
    entry_conditions: dict[str, Any] = Field(default={}, sa_column=Column(JSONB))
    exit_conditions: dict[str, Any] = Field(default={}, sa_column=Column(JSONB))
