-- Migration: 002a_bigint_decimal_safe.sql
-- Safe version: Runs each statement independently, skips TimescaleDB hypertables
-- Date: 2026-01-10

-- ============================================================================
-- PHASE 1: BIGINT TIMESTAMPS (Critical)
-- ============================================================================

-- order_book_snapshots - THE CRITICAL FIX
...
-- ============================================================================
-- PHASE 2: NUMERIC/DECIMAL (Skipping TimescaleDB hypertables)
-- ============================================================================
...
-- SKIPPED: enhanced_candles (TimescaleDB hypertable with compression)
-- SKIPPED: exchange_ticks (TimescaleDB hypertable)
-- SKIPPED: agent_trades (TimescaleDB hypertable)
